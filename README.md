...
```javascript
table = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-emoji-picto-code@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/datasets-emoji-picto-code/tags). For example,

```javascript
table = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-emoji-picto-code@v0.2.3-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var table = require( 'path/to/vendor/umd/datasets-emoji-picto-code/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-emoji-picto-code@umd/browser.js"></script>
```
